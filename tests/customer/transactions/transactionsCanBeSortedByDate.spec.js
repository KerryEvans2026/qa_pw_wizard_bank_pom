...
test('Assert transactions can be sorted by date', async ({ page }) => {
  ...
  await customerAccountPage.fillAmountInputField('500');
  ...
  await customerAccountPage.fillAmountInputField('100');
  ...
  await transactionsPage.clickDateHeader();
